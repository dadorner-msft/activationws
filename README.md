...
- :tada: **Centralized storage of activation data**: Monitor the status of activations and support non-persistent environments like VDI or lab setups, where machines are frequently reimaged or reset
...
- To host the ActivationWs web app on IIS, install the [ASP.NET Core Hosting Bundle](https://dotnet.microsoft.com/en-us/download/dotnet/10.0)
